...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body id="app_body_layout" class="{{ $class ?? 'hold-transition sidebar-collapse sidebar-mini' }}">
        @auth()
        ...
        <div class="fixed-plugin">
          <div class="dropdown show-dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <!--<li class="header-title">Choose Page Layout</li>
              <li>
                 <div>
                     <input type="radio"
                            name="myLayout"
                            value="layout-boxed sidebar-mini"
                            onclick="change_body_class(this);" />
                     <label for="boxed">Boxed</label>

                     <input type="radio"
                            name="myLayout"
                            value="fixed sidebar-mini sidebar-mini-expand-features"
                            onclick="change_body_class(this);" />
                     <label for="fixed">Fixed</label>

                     <input type="radio"
                            name="myLayout"
                            value="sidebar-collapse sidebar-mini"
                            onclick="change_body_class(this);"
                            checked />
    ...
    <script type="text/javascript">
        function change_body_class(myLayout){
            alert(myLayout.value);
            document.getElementById("app_body_layout").className = myLayout.value;
        }
    </script>
</html>
